...
bool USocialComponent::ServerStopCoop_Validate() {
    return true;
}
...
void USocialComponent::ClientApplyCoop_Implementation(AActor* _actor) {
}
bool USocialComponent::ClientApplyCoop_Validate(AActor* _actor) {
    return true;
}
...
bool USocialComponent::BPF_HasCoopGroupReturningToPvE() {
    return false;
}
